...
const Team = () => <section className="bg-white  ">
  <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6 ">
    ...
    <div className="grid gap-8 mb-6 lg:mb-16 md:grid-cols-2">
      {teamCards.length > 0 && teamCards.map((v, i) => <div key={i} className="items-center bg-gray-50 rounded-lg duration-300 transition-all sm:flex group shadow-md hover:shadow-TDarkBlue overflow-hidden md:h-80 h-fit ">
